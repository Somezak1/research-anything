...
一个 Claude Code skill：给它一个想法——可以很模糊，也可以带一堆约束——它会跨**抖音 / 小红书 / 知乎 / B站 / YouTube / GitHub / Twitter(X) / 通用网页** 8 个渠道收集市面上的真实做法，把调研中遇到的陌生名词、新工具交给自主派发的 sub agent 逐个查证补课，逐条核实关键说法，最后基于这些海量信息帮你把需求想明白、把选项收束成**一个切实可行、符合你自身情况的方案**——而不是海量方案的罗列。
...
**2. 需求可以模糊进来、明确出去。** 两种给法都行：

> 模糊需求："周末北京 3 天 2 晚游玩攻略"
>
